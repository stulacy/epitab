...
contingency_table(list("Age at diagnosis"="age",
                       "Sex"="sex"),
                  data=treat, 
                  strata=list("Treated"='treated', "At home"="athome"),
...
contingency_table(list("Age at diagnosis"="age",
                  ...
                  data=treat, 
                  strata=list("Treated"='treated'),
                  models=list("Adjusted odds ratio"=odds_ratio(adjusted = TRUE)))
```
...
contingency_table(list("Age at Diagnosis (years)"="agegrp",
                  ...
                  data=prevsim,
                  frequency = T,
                  strata=list("Five year survival"="fiveyrsurv"),
                  models=list("Hazard ratio"=hazard_ratio("Surv(time, status)"),
...
```{r}
neat_table(contingency_table(list("Age at diagnosis"="age",
                               "Sex"="sex"),
                               data=treat, 
                               strata=list("Treated"='treated'),
                               models=list("Odds ratio"=odds_ratio(),
...
knitr::kable(contingency_table(list("Age at diagnosis"="age",
                               ...
                               strata=list("Treated"='treated'),
                               models=list("Odds ratio"=odds_ratio(),
                                           "Adjusted odds ratio"=odds_ratio(adjusted=TRUE)))$mat,
             "html"
)
```
