...
Arguments:
  ...
  - `independent_level`: A string providing the current independent level. Defaults to `NULL`.
  - `independent`: A string providing the current independent variable. Defaults to `NULL`.
...
```{r}
proportion <- function(outcome_level, outcome_name, data, independent_level=NULL, independent_name=NULL) {
